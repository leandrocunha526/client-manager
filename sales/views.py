...
@login_required
def generate_sale_pdf(request, id):
...
def generate_item_pdf(request, id):
    ...
    data = [["Detalhes do item"],
    ["Código da venda", item.sales_id],
    ["Código do item", item.id],
    ["Código do produto", item.products.id],
    ["Nome do produto", item.products.name],
    ["Descrição do produto", item.products.description],
    ["Quantidade", item.products.quantity],
    ["Desconto", item.discount],
    ["Valor", item.products.price],
    ["Valor total da venda", item.sales.total]]
