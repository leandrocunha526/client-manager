...
from .views import sale_list, DeleteSale, DeleteItemSale, new_sale, item_list, new_item, item_detail, sale_detail, \
    sale_update, item_update, StatsView, generate_sale_pdf, generate_item_pdf
...
urlpatterns = [
    ...
    path('pdf/<int:id>', generate_sale_pdf, name='generate_sale_pdf'),
    path('item/pdf/<int:id>', generate_item_pdf, name='generate_item_pdf')
]
